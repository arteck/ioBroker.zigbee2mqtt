    ...
    initWsClient() {
        ...
        try {
            ...
            this.wsClient.on('open', () => {
                ...
                // (z.B. weil Z2M nach einem dummyMqtt-Neuaufbau noch nicht "bereit" ist),
                // versuche die Geräteliste über die Z2M-WebUI-REST-API nachzuladen.
                // Nur relevant, wenn der Adapter selbst einen (dummy) MQTT-Broker verwaltet –
                // bei rein externem MQTT-Server (dummyMqtt=false) bleibt dieser über einen
                // Adapter-Neustart hinweg unberührt, ein Fallback ist dort nicht nötig.
                if (this.adapter.config.dummyMqtt === true && typeof this.adapter.scheduleDeviceReloadFallback === 'function') {
                    this.adapter.scheduleDeviceReloadFallback();
                }
            });
