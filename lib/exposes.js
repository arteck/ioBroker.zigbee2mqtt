					...
					switch (prop.name) {
						...
						case 'color_temp': {
							...
							pushToStates({
								...
								read: true,
								type: 'number',
								min: useKelvin == true ? utils.miredKelvinConversion(prop.value_max) : prop.value_min,
								max: useKelvin == true ? utils.miredKelvinConversion(prop.value_min) : prop.value_max,
