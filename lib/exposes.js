                ...
                switch (expose.name) {
                    case 'action': {
                        ...
                        for (const actionName of expose.values) {
                            ...
                            if (actionName.endsWith('release') && expose.values.find((x) => x == actionName.replace('release', 'hold'))) {
                                continue;
                            }

                            // is hold state ?
                            if (actionName.endsWith('hold') && expose.values.find((x) => x == actionName.replace('hold', 'release'))) {
                                pushToStates({
