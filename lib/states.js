...
const states = {
    ...
    heiman_execute_warning_strobe_only: {
        // for HEIMAN HS2WD-E
    ...
    bitron_execute_warning: {
        // for Biton AV2010/24A
        id: 'execute_warning',
        prop: 'warning',
        name: 'Execute warning (input: duration in sec)',
        icon: undefined,
    ...
    switch_circle: {
        ...
        type: 'string',
        getter: (payload) =>
            payload.action === 'circle_click' ? 'press' : payload.action === 'circle_hold' ? 'hold' : undefined,
    },
    switch_state: {
        id: 'state',
        prop: 'action',
    ...
    switch_hold: {
        ...
        type: 'string',
        getter: (payload) =>
            payload.action === 'up_hold'
                ? 'up'
                : payload.action === 'down_hold'
                    ? 'down'
                    : payload.action === 'circle_hold'
                        ? 'circle'
                        : undefined,
    },
    switch_release: {
        ...
        type: 'string',
        getter: (payload) =>
            payload.action === 'up_release'
                ? 'up'
                : payload.action === 'down_release'
                    ? 'down'
                    : payload.action === 'circle_release'
                        ? 'circle'
                        : undefined,
    },
    // new RWL states
    rwl_state: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'on-press' ? true : payload.action === 'off-press' ? false : undefined,
    },
    rwl_up_button: {
        id: 'up_button',
        prop: 'action',
...
def: 0,
    ...
    */
    ...
    E1524_left_button: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'arrow_left_hold' ? true : payload.action === 'arrow_left_release' ? false : undefined,
    },
    E1524_right_button: {
        id: 'right_button',
        prop: 'action',
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'arrow_right_hold' ? true : payload.action === 'arrow_right_release' ? false : undefined,
    },
    ...
    E1524_up_button: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'brightness_up_hold'
                ? true
                : payload.action === 'brightness_up_release'
                    ? false
                    : undefined,
    },
    E1743_onoff: {
    ...
    E1743_up_button: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.click === 'brightness_up' ? true : payload.click === 'brightness_stop' ? false : undefined,
    },
    E1743_down_button: {
        id: 'down_button',
        prop: 'click',
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.click === 'brightness_down' ? true : payload.click === 'brightness_stop' ? false : undefined,
    },
    E1524_down_button: {
        id: 'down_button',
        prop: 'action',
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'brightness_down_hold'
                ? true
                : payload.action === 'brightness_down_release'
                    ? false
                    : undefined,
    },
    tint404011_onoff: {
    ...
    SPZB0001_valve_position: {
        ...
        getter: (payload) => {
            return Math.round(payload.eurotronic_valve_position / 2.55);
        },
    },
    SPBZ0001_current_heating_setpoint: {
        //0x4003
    ...
    inserted: {
        ...
        def: 0,
        getter: (payload) =>
            payload.inserted === 'unknown'
                ? -1
                : payload.inserted === undefined
                    ? null
                    : parseInt(payload.inserted, 10),
    },
    forgotten: {
        id: 'forgotten',
        prop: 'forgotten',
    ...
    lock_state: {
        ...
        type: 'string',
        getter: (payload) =>
            payload.state === 'LOCK' ? 'locked' : payload.state === 'UNLOCK' ? 'unlocked' : undefined,
    },
    DIYRUZ_buzzer: {
        id: 'buzzer',
        prop: 'state_center',
    ...
    curtain_xiaomi_reverse_direction: {
        ...
        getter: (payload) =>
			...
			payload.options.hasOwnProperty('reverse_direction') &&
			!isNaN(payload.options.reverse_direction)
                ? payload.options.reverse_direction
                : undefined,
        setterOpt: (value, options) => {
            return { ...options, reverse_direction: value };
        },
    ...
    curtain_xiaomi_hand_open: {
        ...
        inOptions: true,
        getter: (payload) =>
            payload.options !== null && payload.options.hasOwnProperty('hand_open') && !isNaN(payload.options.hand_open)
                ? payload.options.hand_open
                : undefined,
        setterOpt: (value, options) => {
    ...
    aqara_opple_1_hold: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'button_1_hold' ? true : payload.action === 'button_1_release' ? false : undefined,
    },
    aqara_opple_2: {
        id: 'button_2_click',
        prop: 'action',
    ...
    aqara_opple_2_hold: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'button_2_hold' ? true : payload.action === 'button_2_release' ? false : undefined,
    },
    aqara_opple_3: {
        id: 'button_3_click',
        prop: 'action',
    ...
    aqara_opple_3_hold: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'button_3_hold' ? true : payload.action === 'button_3_release' ? false : undefined,
    },
    aqara_opple_4: {
        id: 'button_4_click',
        prop: 'action',
    ...
    aqara_opple_4_hold: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'button_4_hold' ? true : payload.action === 'button_4_release' ? false : undefined,
    },
    aqara_opple_5: {
        id: 'button_5_click',
        prop: 'action',
    ...
    aqara_opple_5_hold: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'button_5_hold' ? true : payload.action === 'button_5_release' ? false : undefined,
    },
    aqara_opple_6: {
        id: 'button_6_click',
        prop: 'action',
    ...
    aqara_opple_6_hold: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'button_6_hold' ? true : payload.action === 'button_6_release' ? false : undefined,
    },
    aqara_opple_mode: {
        id: 'mode',
        prop: 'operation_mode',
    ...
    rm01_row_2: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'row_2_on' ? true : payload.action === 'row_2_off' ? false : undefined,
    ...
    rm01_row_3: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'row_3_on' ? true : payload.action === 'row_3_off' ? false : undefined,
    ...
    rm01_row_4: {
        ...
        type: 'boolean',
        getter: (payload) =>
            payload.action === 'row_4_on' ? true : payload.action === 'row_4_off' ? false : undefined,
    ...
    color_temperature_move_value: {
        ...
        unit: '',
        getter: (payload) =>
            payload.action === 'color_temperature_move' ? payload.action_color_temperature : undefined,
    },
    color_move: {
        id: 'color_move',
        prop: 'action',
    ...
    enhanced_move_enhanced_hue: {
        ...
        unit: '',
        getter: (payload) =>
            payload.action === 'enhanced_move_to_hue_and_saturation' ? payload.action_enhanced_hue : undefined,
    },
    enhanced_move_hue: {
        ...
        unit: '',
        getter: (payload) =>
            payload.action === 'enhanced_move_to_hue_and_saturation' ? payload.action_hue : undefined,
    },
    enhanced_move_saturation: {
        ...
        unit: '',
        getter: (payload) =>
            payload.action === 'enhanced_move_to_hue_and_saturation' ? payload.action_saturation : undefined,
    },
    density: {
        id: 'density',
        prop: 'smoke_density',
    ...
    effect_type: {
        ...
        setter: (value, options) => {
            ...
            if (options && options.hasOwnProperty('effect_speed')) effectjson.speed = options.effect_speed;
    ...
    effect_json: {
        ...
        setter: (value, options) => {
            try {
                ...
                if (options && options.hasOwnProperty('effect_colors'))
                    effectjson.colors = rgb.colorArrayFromString(options.effect_colors);
                if (options && options.hasOwnProperty('effect_type')) effectjson.effect = options.effect_type;
...
*/
    ...
    ptvo_channel_1: {
        ...
        getter: (payload) => {
            ...
            if (measurement) rv.stateid = id + '_' + measurement;
            else rv.stateid = id;
            rv.value = payload.l1;
